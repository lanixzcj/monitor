...
(function ($) {
  ...
  var Drawer = function (element, options, _relatedTarget) {
    ...
    if (this.options.toggle) this.toggle(_relatedTarget)
  }
...
//    if (this.transitioning || this.$element.hasClass('open')) return
    ...
    var startEvent = $.Event('show.bs.drawer', { relatedTarget: _relatedTarget })
  ...
  Drawer.prototype.toggle = function (_relatedTarget) {
    this.$element.hasClass('open') ? this.hide() : this.show(_relatedTarget)
  }
  ...
  function Plugin(option, _relatedTarget) {
    return this.each(function () {
      ...
      if (!data) $this.data('bs.drawer', (data = new Drawer(this, options, _relatedTarget)))
  ...
  $(document).on('click.bs.drawer.data-api', '[data-show="drawer"]', function (e) {
    var $this   = $(this)
    ...
    var $target = getTargetFromTrigger($this)
    var data    = $target.data('bs.drawer')
    var option  = data ? 'show' : $.extend({}, $this.data(), { trigger: this })
